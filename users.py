...
class User(Base):
    """
    Описывает структуру таблицы user для хранения записей данных пользователя
    """
...
def request_data():
    ...
    gender = input("А теперь пол (Male или Female): ")
    email = input("Мне еще понадобится адрес твоей электронной почты: ")
    birthdate = input("Введи дату рождения (год-месяц-день): ")
